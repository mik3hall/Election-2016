...
testEG <- function() {
  ...
  eg.test.wasted <- efficiencyGap(dem,rep)
  cat("wasted data 1",eg.test.wasted,"\n")
  eg.test.shares <- quickEfficiencyGap(dem,rep)[1,"Efficiency Gap"]
  cat("shares data 1",eg.test.shares,"\n")
  dem <- c(53,53,53,53,15)
  rep <- c(47,47,47,47,85)
  eg.test.wasted <- efficiencyGap(dem,rep)
  cat("wasted data 2",eg.test.wasted,"\n")
  eg.test.shares <- quickEfficiencyGap(dem,rep)[1,"Efficiency Gap"]
  cat("shares data 2",eg.test.shares,"\n")
  #
  # Vary voter turnout
  #
  cat(" ")
  ...
  eg.test.wasted <- efficiencyGap(dem,rep)
  cat("wasted data 3",eg.test.wasted,"\n")
  eg.test.shares <- quickEfficiencyGap(dem,rep)[1,"Efficiency Gap"]
  cat("shares data 3",eg.test.shares,"\n")
}
...
a12 <- impute(a12)
cat("Efficiency Gap calculation based on seat margin and vote margin shares - 2012\n")
eg <- quickEfficiencyGap(a12$dem,a12$rep)
eg
cat("Efficiency Gap calculation based on wasted votes - 2012")
...
a14 <- impute(a14)
cat("Efficiency Gap calculation based on seat margin and vote margin shares - 2014\n")
eg <- quickEfficiencyGap(a14$dem,a14$rep)
eg
cat("Efficiency Gap calculation based on wasted votes - 2014\n")
eg.wasted <- efficiencyGap(a14$dem,a14$rep)*100
eg.wasted
#eg.test <- testEG()
#eg.test
```
