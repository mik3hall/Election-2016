...
Which doesn't look much like our list of six critical swing states which I would still believe is the inadequacy of the data at this level.

## Simulations

## Monte Carlo

But more sophisticated simulation approaches could possibly compenstate for the lack of data. A Monte Carlo simulation can be attempted.
